package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1066:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1255 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1255);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1467 & const_1066)
         {
            if(_loc3_ == 0)
            {
