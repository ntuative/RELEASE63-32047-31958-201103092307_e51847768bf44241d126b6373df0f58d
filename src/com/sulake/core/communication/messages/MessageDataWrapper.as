package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_1092:IProtocolDecoder;
      ...
      {
         return this.var_1092.readString(this._data);
      }
      
      public function readInteger() : int
      {
         return this.var_1092.readInteger(this._data);
      }
      
      public function readBoolean() : Boolean
      {
         return this.var_1092.readBoolean(this._data);
      }
      
      public function readShort() : Short
      {
         return this.var_1092.readShort(this._data);
      }
