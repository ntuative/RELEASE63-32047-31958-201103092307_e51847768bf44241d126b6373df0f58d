package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_599:Map = new Map();
      
      private static const const_331:Map = new Map();
      
      private static var var_1086:Boolean = false;
      ...
      public static function method_10(param1:String) : Boolean
      {
         return const_599.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1086)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_599.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1086 = true;
         }
