package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_515:Array;
      ...
      private static const const_1343:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_87[const_178],var_87[ITALIC],var_87[BOLD]];
            var_87.reset();
            var_87[const_178] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_515.indexOf(_loc4_.name) == -1)
            {
               var_515.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_611);
         if(countSubStrings(param1,const_610) != countSubStrings(param1,const_611))
         {
            throw new Error("Mismatching amount of \"" + const_610 + "\" versus \"" + const_611 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1343) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1344) + 2,_loc5_.length);
            }
