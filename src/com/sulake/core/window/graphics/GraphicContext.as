package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1531:uint = 0;
      
      public static const const_723:uint = 1;
      
      public static const const_1127:uint = 2;
      
      public static const const_681:uint = 4;
      
      public static const const_1608:uint = 8;
      
      public static const const_1501:uint = 16;
      
      public static const const_1864:uint = 64;
      
      public static const const_1848:uint = 128;
      
      public static const const_1187:uint = 256;
      
      protected static var var_540:uint = 0;
      
      protected static var var_324:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_723:
               ...
               break;
            case GraphicContext.const_1127:
         ...
         if(this.var_803)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_324 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2008,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2008,16777215);
                  }
                  var_324 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_803)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_324 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
