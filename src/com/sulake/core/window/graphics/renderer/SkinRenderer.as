   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinTemplate(this.var_385[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinTemplate = this.var_385[param2];
         if(_loc3_ == null)
         {
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_385[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_448)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_448[_loc3_] == param1)
               {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_385[param1.name];
         }
         return param1;
      }
   }
