package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1127,var_11);
         }
         return var_22;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_488)
         {
            this.focus();
         }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_357,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_629,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1606);
         _loc1_.push(this.var_1249 != PropertyDefaults.const_1172 ? new PropertyStruct(PropertyDefaults.const_671,this.var_1249,PropertyStruct.const_36,true) : PropertyDefaults.const_1627);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1044 ? new PropertyStruct(PropertyDefaults.const_868,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1394);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1113 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1437);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_671:
                  this.var_1249 = _loc2_.value as Boolean;
                  if(this.var_1249)
                  {
               ...
               case PropertyDefaults.const_629:
                  ...
                  break;
               case PropertyDefaults.const_1182:
