package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1220:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_439)
         {
            this.var_439.removeEventListener(WindowEvent.const_280,this.scrollBarEventProc);
            this.var_439.removeEventListener(WindowEvent.const_228,this.scrollBarEventProc);
            this.var_439 = null;
         }
         if(this.var_1220)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1220)
         {
            this.var_1220 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_439)
         {
            ...
            if(this.var_439)
            {
               this.var_439.addEventListener(WindowEvent.const_280,this.scrollBarEventProc);
               this.var_439.addEventListener(WindowEvent.const_228,this.scrollBarEventProc);
            }
         }
         return this.var_439;
      }
      ...
      {
         if(param1.type == WindowEvent.const_280)
         {
            this.showScrollBar();
         }
