package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_261.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_484,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_181 == null || this.var_181.disposed)
         {
            this.var_181 = context.create(name + "::submenu","",WindowType.const_523,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_261.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_928 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_928)
         {
            if(this.open())
            {
               if(this.var_261.length)
               {
                  this.populateMenuItemContainer(this.var_261,this.getSubMenu(),this.subMenuEventProc);
                  this.var_928 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_928 = false;
            this.getTitleLabel().text = this.var_612 < this.var_261.length && this.var_612 > -1 ? this.var_261[this.var_612] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_563,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_345,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_612).setStateFlag(WindowState.const_55,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_488)
         {
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_261[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_261.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_674,this.var_261,PropertyStruct.const_127,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_674)
            {
