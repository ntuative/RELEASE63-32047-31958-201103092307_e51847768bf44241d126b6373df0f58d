package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_808:Number;
      
      protected var var_537:Number;
      
      protected var var_538:Boolean;
      ...
      {
         this.var_808 = param1;
         this._field.scrollH = this.var_808 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_808 * this.maxScrollH,this.var_537 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1173) ? new PropertyStruct(PropertyDefaults.const_701,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1170) : PropertyDefaults.const_1543);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1002 ? new PropertyStruct(PropertyDefaults.const_715,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1079) : PropertyDefaults.const_1532);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1055 ? new PropertyStruct(PropertyDefaults.const_1175,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1124) : PropertyDefaults.const_1424);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_661) ? new PropertyStruct(PropertyDefaults.const_372,this._field.textColor,PropertyStruct.const_155,true) : PropertyDefaults.const_1133);
         ...
         _loc1_.push(this.var_39.left != PropertyDefaults.const_752 ? new PropertyStruct(PropertyDefaults.const_241,this.var_39.left,PropertyStruct.const_40,true) : PropertyDefaults.const_555);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_839 ? new PropertyStruct(PropertyDefaults.const_237,this.var_39.top,PropertyStruct.const_40,true) : PropertyDefaults.const_537);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_881 ? new PropertyStruct(PropertyDefaults.const_227,this.var_39.right,PropertyStruct.const_40,true) : PropertyDefaults.const_577);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_811 ? new PropertyStruct(PropertyDefaults.const_223,this.var_39.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_565);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_991 ? new PropertyStruct(PropertyDefaults.const_772,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1448);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_259,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_259,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_259,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
