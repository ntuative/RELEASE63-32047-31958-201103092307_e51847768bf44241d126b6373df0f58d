package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1327:String = "_TITLE";
      
      private static const const_1331:String = "_HEADER";
      
      private static const const_1332:String = "_CONTENT";
      
      private static const const_1330:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1429:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1327) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1429 = findChildByTag(const_1331) as IHeaderWindow;
            if(!this.var_1429)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_175 = findChildByTag(const_1332) as IWindowContainer;
            if(!this.var_175)
            {
      ...
      {
         return findChildByTag(const_1330) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1232,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1006 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_323);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,_loc3_.left,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,_loc3_.top,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_227,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_223,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         }
         else
         {
