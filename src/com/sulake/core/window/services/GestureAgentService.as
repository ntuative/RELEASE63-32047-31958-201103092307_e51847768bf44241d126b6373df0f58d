package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1467:uint = 0;
      
      protected var var_278:Function;
      
      protected var var_1244:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1244 *= 0.75;
         this.var_1243 *= 0.75;
         if(Math.abs(this.var_1244) <= 1 && Math.abs(this.var_1243) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_278 != null)
         {
            this.var_278(this.var_1244,this.var_1243);
         }
      }
