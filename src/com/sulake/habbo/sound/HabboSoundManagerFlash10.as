package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_948:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1188,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_950.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1052:
               ...
               case HabboSoundTypesEnum.const_1015:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1412:
            ...
            this.var_950.add(param1,_loc2_);
         }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_767.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_767,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_949.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_949 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_177 == null || this._connection == null || this._roomEngine == null || this.var_511 != null)
         {
            return;
         }
         this.var_511 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_626.getValue(_loc2_);
         ...
         this.var_626.remove(_loc2_);
         this.var_767.add(_loc3_,_loc6_);
         if(this.var_626.length == 0 && this.var_766 != -1)
         {
            this.var_948.ready = true;
            _loc7_ = this.var_766;
            this.var_766 = -1;
            this.var_948 = null;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1188,_loc7_));
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_511.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1434,this.var_766));
         this.var_766 = -1;
         this.var_948 = null;
      }
      ...
      {
         this._volume = param1;
         this.var_511.updateVolume(this._volume);
