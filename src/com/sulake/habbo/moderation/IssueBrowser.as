package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1681:IIssueBrowserView;
      
      private var var_1680:IIssueBrowserView;
      
      private var var_1682:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_247 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_247.numTabItems)
            {
               _loc5_ = this.var_247.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_247 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_247 == null || this.var_247.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_247.selector.getSelectableByName("open_issues");
         this.var_247.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_344 == _loc2_)
         {
            return;
         }
         if(this.var_344 != null)
         {
            this.var_344.visible = false;
         }
         this.var_344 = _loc2_;
         if(this.var_344 == null)
         {
         ...
         this.var_344.view.width = this.var_247.container.width;
         this.var_344.view.height = this.var_247.container.height;
         this.var_344.visible = true;
         this.var_344.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1996:
               ...
               {
                  this.var_1681 = new MyIssuesView(this.issueManager,this,this.var_247.container);
               }
               return this.var_1681;
            case this.const_1994:
               if(this.var_1680 == null)
               {
                  this.var_1680 = new OpenIssuesView(this.issueManager,this,this.var_247.container);
               }
               return this.var_1680;
            case this.const_1995:
               if(this.var_1682 == null)
               {
                  this.var_1682 = new PickedIssuesView(this.issueManager,this,this.var_247.container);
               }
