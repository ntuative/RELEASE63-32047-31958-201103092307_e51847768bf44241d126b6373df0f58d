package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2850:String = "magic.credits";
      
      private var var_2800:String = "magic.pixels";
      
      private var var_2799:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2800);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2799,true);
      }
