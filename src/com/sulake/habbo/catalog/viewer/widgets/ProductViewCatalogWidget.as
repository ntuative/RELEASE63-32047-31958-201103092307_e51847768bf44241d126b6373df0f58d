package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1662:Point;
      
      private var var_481:IItemGridWindow;
      
      private var var_1340:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1662 = new Point(this.var_85.x,this.var_85.y);
         this.var_481 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1340 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1663 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1089.y = this.var_872.y + this.var_872.height;
                     ...
                     case ProductTypeEnum.const_264:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_277,AvatarAction.const_463);
                              _loc16_.appendAction(AvatarAction.const_282,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2293)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2293 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1662.x;
            this.var_85.y = this.var_1662.y;
            if(param3 != null)
            {
