package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1130:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1129);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1129);
      }
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1553:
               if(this.var_1130 == null)
               {
                  this.var_1130 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1130);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1582:
               ...
               break;
            case CatalogWidgetEnum.const_1520:
            ...
            case CatalogWidgetEnum.const_1666:
               ...
               break;
            case CatalogWidgetEnum.const_1646:
            ...
            case CatalogWidgetEnum.const_1480:
               ...
               break;
            case CatalogWidgetEnum.const_1620:
