package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_720)
         {
            this.var_720 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_720)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_721)
         {
            this.var_721 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_721)
            {
               return;
            }
