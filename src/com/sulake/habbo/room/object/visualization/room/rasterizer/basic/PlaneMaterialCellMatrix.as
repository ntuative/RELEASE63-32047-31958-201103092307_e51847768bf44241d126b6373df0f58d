package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1450:int = const_343;
      ...
      public static const const_281:int = const_125;
      ...
      private var var_670:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2095 = param6;
         this.var_2096 = param7;
         this.var_670 = new Vector3d();
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_670 != null)
         {
            this.var_670.assign(new Vector3d());
         }
         this.var_546 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_670,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_546,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1537 == const_125)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_546);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_546,this.var_30.width,this.var_546);
         }
