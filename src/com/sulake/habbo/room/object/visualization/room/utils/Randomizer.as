package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1817:int = 16777216;
      ...
      private var var_1873:int = 16777216;
      
      private var var_2821:int = 69069;
      
      private var var_2820:int = 5;
      ...
      {
         var _loc1_:int = this.var_2821 * this.var_1872 + this.var_2820;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1873;
         this.var_1872 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1873 * param2);
      }
   }
}
