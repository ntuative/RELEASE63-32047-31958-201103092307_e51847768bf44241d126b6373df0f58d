package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1745:int = 255;
      
      private var var_1368:uint = 16777215;
      
      private var var_1744:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1202,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_645,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_770,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_906,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_662,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1120)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1745;
            if(_loc2_ - this.var_1120 >= this.var_1743)
            {
               _loc3_ = this.var_1121;
               _loc4_ = this.var_1746;
               this.var_1120 = 0;
            }
            else
            {
               _loc7_ = this.var_1368 >> 16 & 255;
               _loc8_ = this.var_1368 >> 8 & 255;
               _loc9_ = this.var_1368 & 255;
               _loc10_ = this.var_1121 >> 16 & 255;
               _loc11_ = this.var_1121 >> 8 & 255;
               _loc12_ = this.var_1121 & 255;
               _loc13_ = (_loc2_ - this.var_1120) / this.var_1743;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1744 + (this.var_1746 - this.var_1744) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_645,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_695:
               param2.setString(RoomObjectVariableEnum.const_878,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_875:
               param2.setString(RoomObjectVariableEnum.const_672,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_428:
               _loc5_ = "null";
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1051,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1140:
               param2.setNumber(RoomObjectVariableEnum.const_770,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1050:
               param2.setNumber(RoomObjectVariableEnum.const_906,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_662,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1368 = this._color;
         this.var_1744 = this.var_1745;
         this.var_1121 = _loc3_;
         this.var_1746 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_541,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1488,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1609,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1400,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_541,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_188)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_161 || _loc13_ == RoomPlaneData.const_317)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
