package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1528 = param1.id;
         this._type = param1.petType;
         this.var_2535 = param1.petRace;
         this.var_45 = param1.image;
         this.var_2313 = param1.isOwnPet;
         this.var_2081 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1269 = param1.level;
         this.var_2310 = param1.levelMax;
         this.var_2079 = param1.experience;
         this.var_2314 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2309 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2312 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2244 = param1.roomIndex;
         this.var_483 = param1.age;
      }
   }
}
