package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_63,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1279,const_1278,2,2),null,0) as IWindowContainer;
         ...
         this.var_247 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_247.numTabItems)
         {
            _loc6_ = this.var_247.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1369 = _loc2_.light;
         if(this.var_414 != null)
         {
            this.var_414.setValue(this.var_1369);
         }
         this.var_498 = this.colors.indexOf(_loc2_.color);
         if(this.var_591 != null)
         {
            this.var_591.setSelectedColorIndex(this.var_498);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_247.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_247.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_247.selector.getSelected();
         return this.var_247.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1370 = XML(_loc1_.content);
         return this.var_1370;
      }
