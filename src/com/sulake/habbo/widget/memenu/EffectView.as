package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2007:int = 1000;
      ...
      private var var_960:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_196 = new Timer(this.const_2007);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_183.isActive)
         {
            ...
            this.var_959.width = _loc2_ * this.var_298;
         }
         else
         {
            this.var_959.width = 0;
            this.var_196.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_775 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_775 == null)
            {
               return;
            }
         ...
         if(!this.var_183.isActive)
         {
            this.var_775.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_775.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_775.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_960 = this._window.findChildByName("effect_hilite");
            this.var_960.visible = false;
         }
         this.setTimeLeft();
         this.var_959 = this._window.findChildByName("loader_bar");
         if(this.var_959 != null)
         {
            this.var_298 = this.var_959.width;
            this.var_196.start();
            this.onUpdate();
         }
