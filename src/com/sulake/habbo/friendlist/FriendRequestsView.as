package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1701:String = "no_reqs_info";
      ...
      {
         this.var_1621 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1622 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1622.procedure = this.onDismissAllButtonClick;
         this.var_1621.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_998)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_285,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_358 && _loc4_.state != FriendRequest.const_375)
            {
               _loc4_.state = FriendRequest.const_375;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_285,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1621,_loc1_);
         this.setEnabled(this.var_1622,_loc1_);
      }
