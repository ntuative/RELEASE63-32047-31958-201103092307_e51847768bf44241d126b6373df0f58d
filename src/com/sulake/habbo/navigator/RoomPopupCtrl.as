package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2277 = new RoomThumbnailRenderer(param1);
         this.var_1023 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_180,this.var_111);
         if(this.var_111.ownerName != "" && this.var_111.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_180,!!this.var_111.event ? this.getEventCtg(this.var_111.categoryId) : this.getRoomCtg(this.var_111.categoryId));
         this.refreshRoomDesc(this.var_180,this.var_111);
         this.refreshExtraCont();
         this.refreshInfo(this.var_180,"trading_allowed",this.var_111.allowTrading);
         this.refreshInfo(this.var_180,"doormode_doorbell",this.var_111.doorMode == 1);
         this.refreshInfo(this.var_180,"doormode_password",this.var_111.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_180,this.var_111.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1023.refreshTags(_loc1_,this.var_111.tags);
         ...
         this.var_2277.refreshThumbnail(_loc1_,this.var_111.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_216,Tabs.const_230,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
