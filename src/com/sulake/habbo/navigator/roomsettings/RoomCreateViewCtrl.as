package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1051:TextFieldManager;
      
      private var var_43:Array;
      
      private var var_1050:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1050.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1607 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1607 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1051 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_175.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1051.goBackToInitialState();
         this.var_1051.input.textBackgroundColor = 4294967295;
         this.var_1050 = this.var_43[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_63,HabboWindowStyle.const_31,HabboWindowParam.const_58,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1051.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1051.getText();
         var _loc3_:String = "model_" + this.var_1050.name;
