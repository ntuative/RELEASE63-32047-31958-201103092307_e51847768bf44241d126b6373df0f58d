   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id >= 0)
         {
            ...
            _loc3_.userDataManager.updateAchievementScore(_loc2_.id,_loc2_.method_1);
            listener.events.dispatchEvent(new RoomSessionUserFigureUpdateEvent(_loc3_,_loc2_.id,_loc2_.figure,_loc2_.sex,_loc2_.customInfo,_loc2_.method_1));
         }
      }
