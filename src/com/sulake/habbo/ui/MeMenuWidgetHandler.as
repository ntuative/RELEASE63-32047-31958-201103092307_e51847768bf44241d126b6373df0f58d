   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_295,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_847,this.onAvatarEffectsChanged);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_481,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_295,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_847,this.onAvatarEffectsChanged);
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_481,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1374)
            {
               ...
               this.var_1374 = _loc2_;
               this.var_1753 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1753;
            }
         }
         if(this.var_170 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_995,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_803);
         _loc1_.push(RoomWidgetDanceMessage.const_902);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_656);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_627);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_836);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_685);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_880);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_383);
         _loc1_.push(RoomWidgetStopEffectMessage.const_866);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1610);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1475);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1020);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_675);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_702);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_788);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1500);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_842);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_908);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_721);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_407);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_702:
               ...
               break;
            case RoomWidgetWaveMessage.const_803:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_902:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_656:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_627:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_836:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_383:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1135)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_181,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_880:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1049:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1555:
            ...
            case RoomWidgetStopEffectMessage.const_866:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1070:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1538:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1058:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_675:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_872:
               ...
               if(this.var_170)
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_670:
               ...
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_586,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_362:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_788:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_842:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_355,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_908:
            ...
            case RoomWidgetAvatarEditorMessage.const_721:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_467));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_407:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_640));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_837));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_481:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_485));
         }
      }
