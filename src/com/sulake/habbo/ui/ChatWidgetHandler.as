package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      {
         return [RoomWidgetChatMessage.const_794,RoomWidgetChatSelectAvatarMessage.const_660];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_41) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1009))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_41) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1009))
                              {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_735 == null)
            {
               ...
               this.var_495.y = 0;
               this.var_495.z = 0;
               this.var_735 = _loc4_.getScreenPoint(this.var_495);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1770.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1770.remove(param1);
         if(_loc3_ != null)
         {
