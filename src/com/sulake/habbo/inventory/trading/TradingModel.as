package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1619:uint = 9;
      ...
      public static const const_309:uint = 3;
      
      public static const const_425:uint = 4;
      
      public static const const_272:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_55.updateItemList(this.var_744);
         this.var_55.updateItemList(this.var_1394);
      ...
      public function close() : void
      {
         if(this.var_729)
         {
            if(this._state != const_176 && this._state != const_272)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_745 + " OTHER: " + this.var_1149);
         ...
         {
            case const_176:
               if(param1 == const_199 || param1 == const_272)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1138);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_745 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_55.alertPopup(TradingView.const_1143);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_256.length < const_1619)
         {
