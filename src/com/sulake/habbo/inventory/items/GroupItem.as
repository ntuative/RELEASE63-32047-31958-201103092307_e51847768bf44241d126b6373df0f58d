package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_810:int = 0;
      
      protected var var_657:BitmapData;
      ...
      protected var var_2781:BitmapData;
      
      private const const_1990:int = 8947848;
      
      private const const_1991:int = 13421772;
      
      private const const_1728:Number = 1;
      
      private const const_1729:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2780 == FurniModel.const_43)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1446));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2018);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_860)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1729;
               _loc1_.blend = this.const_1729;
            }
            else
            {
               this._window.blend = this.const_1728;
               _loc1_.blend = this.const_1728;
            }
         }
         if(this.isSelected)
         {
