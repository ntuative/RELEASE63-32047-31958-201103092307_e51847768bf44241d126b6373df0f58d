package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_402:String = "pets";
      ...
      private var var_1865:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_507 = param8;
         this.var_624 = new Timer(const_1336,1);
         this.var_624.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2611 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_507);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_624.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_624.stop();
               this.var_624 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1865 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1865;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_368)
         {
         ...
         else if(param3 == FurniCategory.const_385)
         {
         ...
         else if(param3 == FurniCategory.const_381)
         {
         ...
         if(this.var_947 == null)
         {
            this.var_947 = this._windowManager.buildFromXML(this.var_2611) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_947.clone() as IWindowContainer;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_625.add(const_43,new Array());
         this.var_625.add(const_50,new Array());
         if(this.var_17 != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_385 || _loc3_.category == FurniCategory.const_368 || _loc3_.category == FurniCategory.const_381)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1441 && param1.type == RoomEngineObjectEvent.const_222)
         {
            this.var_1441 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_625.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_860)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
