package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1280:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_550 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_550.width;
         this.var_91 = this.var_550.height;
         this.var_1041 = param5;
         this.var_841 = param6;
         this.var_211 = Math.floor(this.var_1041 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1041,this.var_841);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_211 * this._thumbWidth,this.var_1041),Math.max(this.var_549 * this.var_91,this.var_841),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_211 && this.var_26.height < _loc3_.y * this.var_91)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_211 - 1),this.var_91);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_211 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_91),null,null,true);
         _loc4_ = new Rectangle(0,this.var_91,this._thumbWidth * (this.var_211 - 1),this.var_26.height - this.var_91);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1280.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_841)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_841);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_550.width,this.var_550.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_550.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_550,this.var_550.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
