package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2751:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_648 = param1;
            this.var_56.initConnection(HabboConnectionType.const_249);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_56.addHabboConnectionMessageEvent(new PingMessageEvent(this.method_8));
      ...
      {
         if(this.var_56 && this.var_166 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_648 = this.var_166.getKey("sso.ticket",null);
         this.var_1956 = this.var_166.getKey("flash.client.url","");
         this.var_2753 = this.var_166.getKey("external.variables.txt","");
         if(this.var_230 == null)
         {
            this.var_230 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_56.mode = HabboConnectionType.const_88;
            if(this.var_648)
            {
               this.var_56.initConnection(HabboConnectionType.const_249);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_17.addEventListener(HabboLoginDemoView.const_437,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1086;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_249);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_765);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2751 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_88:
               ...
               this.var_230.loadBannerImage(_loc7_ + "?token=" + this.var_1495,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1086:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1622:
               this.var_990 = this.generateRandomHexString(30);
               this.var_530 = new DiffieHellman(new BigInteger(this.var_166.getKey("connection.development.prime"),16),new BigInteger(this.var_166.getKey("connection.development.generator"),16));
               this.var_530.init(this.var_990);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2751);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1956,this.var_2753));
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_648 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_648);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2752)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1495);
