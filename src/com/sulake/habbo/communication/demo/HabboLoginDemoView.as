package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_437:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_143.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_141,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_123.removeEventListener(SSOTicket.const_356,this.onParsedTicketSuccess);
            this.var_123.removeEventListener(SSOTicket.const_312,this.onParsedTicketFailure);
            this.var_123 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_123 = new SSOTicket(this.var_143.assets,_loc3_,_loc2_,param1);
         this.var_123.addEventListener(SSOTicket.const_356,this.onParsedTicketSuccess);
         this.var_123.addEventListener(SSOTicket.const_312,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_143.shockwaveClientUrl = this.var_123.shockwaveClientUrl;
         this.var_143.ssoTicket = this.var_123.ticket;
         this.var_123.removeEventListener(SSOTicket.const_356,this.onParsedTicketSuccess);
         this.var_123.removeEventListener(SSOTicket.const_312,this.onParsedTicketFailure);
         this.var_123 = null;
         dispatchEvent(new Event(const_437));
