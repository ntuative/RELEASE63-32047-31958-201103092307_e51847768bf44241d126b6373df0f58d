package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_630:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_630 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_630.numGridItems > 0)
         {
            this.var_630.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_67 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_67.hotLooks)
         {
            ...
            this.var_630.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_630.getGridItemIndex(param2.parent);
