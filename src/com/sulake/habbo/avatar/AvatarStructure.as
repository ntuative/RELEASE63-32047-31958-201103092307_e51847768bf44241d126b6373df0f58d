package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_436:PartSetsData;
      ...
      private var var_1469:PartOffsetData;
      ...
      {
         this.var_1469.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_965 = new AvatarActionManager(param1,this.var_522,param2);
         this.var_842 = this.var_965.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         if(this.var_436.parse(param1))
         {
            if(this.var_522 == AvatarType.const_126)
            {
               this.var_436.getPartDefinition("ri").appendToFigure = true;
               this.var_436.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_637[param1] = new Dictionary();
         }
         if(this.var_637[param1][param2])
         {
            return this.var_637[param1][param2];
         }
         this.var_637[param1][param2] = this.var_377.getMandatorySetTypeIds(param1,param2);
         return this.var_637[param1][param2];
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_436.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_436.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1468[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_436.getActiveParts(param3.definition);
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           _loc12_ = this.var_436.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_436.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1469.getOffset(param1,param2,param3,param4,param5,param6);
      }
