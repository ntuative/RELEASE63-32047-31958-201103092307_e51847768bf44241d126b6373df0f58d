package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_952:uint = 11;
      ...
      private var var_1135:IHabboWindowManager;
      
      private var var_170:IHabboToolbar;
      
      private var var_135:IHabboHelp;
      ...
      private var var_595:LagWarningLogger = null;
      
      private var var_593:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_595 = new LagWarningLogger();
         this.var_593 = new ToolbarClickTracker(this);
         this.var_1379 = new Array(const_952);
         var _loc4_:int = 0;
         while(_loc4_ < const_952)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1669,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1418,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1650,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_862,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1135)
            {
               this.var_1135.release(new IIDHabboWindowManager());
               this.var_1135 = null;
            }
            if(this.var_314)
            {
            ...
            if(this.var_193)
            {
               ...
               {
                  Component(this.var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_193).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_193).events.removeEventListener(HabboFriendListTrackingEvent.const_384,this.onFriendlistTrackingEvent);
               }
               this.var_193.release(new IIDHabboFriendList());
               this.var_193 = null;
            }
            if(this.var_135)
            {
               if(!this.var_135.disposed)
               {
                  this.var_135.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_135.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_135.release(new IIDHabboHelp());
               this.var_135 = null;
            }
            if(this.var_170)
            {
               ...
               {
                  this.var_170.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_177)
         {
            if(this.var_252 != null)
            {
               this.var_252.configuration = this.var_177;
            }
            if(this.var_253 != null)
            {
               this.var_253.configuration = this.var_177;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1557);
            if(this.var_177)
            {
               if(this.var_595 != null)
               {
                  this.var_595.configure(this.var_177);
               }
               if(this.var_594 != null)
               {
                  this.var_594.configure(this.var_177);
               }
               if(this.var_593 != null)
               {
                  this.var_593.configure(this.var_177);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_765,this.onConnectionEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_595 != null)
            {
               this.var_595.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1423);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1580);
               break;
            case HabboCommunicationEvent.const_765:
      ...
      {
         this.var_1135 = IHabboWindowManager(param2);
         if(this.var_1135)
         {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1028);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1028,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_193 = param2 as IHabboFriendList;
         Component(this.var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_193).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_193).events.addEventListener(HabboFriendListTrackingEvent.const_384,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_384:
      ...
      {
         this.var_135 = param2 as IHabboHelp;
         this.var_135.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_135.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_862,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_288,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_314 = param2 as IAdManager;
         this.var_314.events.addEventListener(AdEvent.const_556,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_170 = param2 as IHabboToolbar;
         this.var_170.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_593)
         {
            this.var_593.track(param1.iconName);
         }
      }
      ...
      {
         this.var_595.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1768;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1768);
         }
         if(this.var_493 > -1 && _loc2_ - this.var_493 > 15000)
         {
            ++this.var_1767;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1767);
         }
         this.var_493 = _loc2_;
         if(this.var_253 != null)
         {
            this.var_253.update(param1,this.var_493);
         }
         if(this.var_252 != null)
         {
            this.var_252.update(param1,this.var_493);
         }
         if(this.var_594 != null)
         {
            this.var_594.trackUpdate(param1,this,this.var_493);
         }
         if(this.var_595 != null)
         {
            this.var_595.update(this.var_493);
         }
      }
   }
}
